...
for (i in 100:999) {
   ...
   number_word <- 
      paste0(twenty_or_less[floor((i / 100))], "hundred")
   remainder <- 
      i - (100 * floor(i / 100))
   ...
   if (remainder > 0) {
      ...
      if (remainder < 21) {
         ...
         number_word <- 
            paste0(number_word, ten_and_multiples[floor(remainder / 10)])
         number_word <- 
            paste0(number_word, twenty_or_less[remainder - (10 * floor(remainder / 10))])
      }
   }
